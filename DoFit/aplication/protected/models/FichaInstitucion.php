...
class FichaInstitucion extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_institucion, cuit, id_localidad, direccion, fhcreacion, cusuario', 'required'),
			...
			array('id_ficha, id_institucion, cuit, telfijo, celular, id_localidad, direccion, piso, depto, fhcreacion, fhultmod, cusuario', 'safe', 'on'=>'search'),
		);
	}
