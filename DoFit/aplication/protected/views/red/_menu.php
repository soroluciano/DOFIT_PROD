        ...
        <nav id="bs-navbar" class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
               <!-- <li><a href="javascript:onclick="getMensajesFromBase();" alt="mensajes"><span class="glyphicon glyphicon-envelope"></span><span class="alerta_new"><?php //echo "1";?></span></a></li>-->
                <li><a onclick="getMensajesFromBase()" style="cursor:pointer;" alt="notificaciones"><span class="glyphicon glyphicon-globe"></span><span class="alerta_new" id="notificacion"></span></a></li>
