...
<div class="container">
  <div class='row'>
    <div>
        <h1>Modificar <?php echo $ficha_profesor->nombre; ?></h1>
    </div>
	<div class="form">
	 ...
	 <div class="form-group">
                ...
                <?php echo $form->textField($ficha_profesor,'nombre',array('size'=>200,'maxlength'=>200,'class'=>"form-control",'placeholder'=>"Gimnasio")); ?>
                <?php echo $form->error($ficha_profesor,'nombre'); ?>
            </div>
            <div class="form-group">
                <?php echo $form->labelEx($ficha_profesor,'apellido'); ?>
                <?php echo $form->textField($ficha_profesor,'apellido',array('size'=>11,'maxlength'=>11,'class'=>"form-control",'placeholder'=>"Cuit")); ?>
