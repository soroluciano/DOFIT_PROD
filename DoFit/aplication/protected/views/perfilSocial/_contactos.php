						...
						<?php
								...
								foreach($contactos as $cn){
									...
									echo"<li class='list-group-item'>
										...
										if($perfil->foto1!=null){
												echo "<img src='".Yii::app()->request->baseUrl."/uploads/".$perfil->foto1."' onclick='getProfileFriend(".$cn['id_usuario'].")' width='120px' height='120px' class='img-circle' style='cursor:pointer' />";
										}else{
