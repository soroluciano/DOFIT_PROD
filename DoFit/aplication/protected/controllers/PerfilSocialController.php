...
/*
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['PerfilSocial']))
		{
			$model->attributes=$_POST['PerfilSocial'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('PerfilSocial');
	...
	{
		$model=new PerfilSocial('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['PerfilSocial']))
			$model->attributes=$_GET['PerfilSocial'];
	 ...
	 * @return PerfilSocial the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=PerfilSocial::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param PerfilSocial $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='perfil-social-form')
		{
